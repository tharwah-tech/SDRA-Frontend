...
export class AgentsMockService implements AgentsRepository {
  private mockAgents: AgentEntity[] = [
    {
      ...
      role: 'Interviewer',
      description:
        'Your professional AI interview agent designed to conduct comprehensive candidate evaluations with expertise and consistency.',
    ...
    },
    {
      ...
      role: 'HR Specialist',
      description:
        'Expert AI agent specialized in HR processes, employee onboarding, and company culture assessment.',
    ...
    },
    {
      ...
      description:
        'Specialized in conducting technical interviews and coding assessments for software engineering positions.',
  ...
  getAgents(): Observable<AgentSummaryEntity[]> {
    return of(this.mockAgents).pipe(
      delay(500),
      map((dataList) =>
        dataList.map((item) => {
          return {
